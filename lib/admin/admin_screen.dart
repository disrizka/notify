          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
                  Text("Halo, Admin Rizka!", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height: 5),
                  Text("Pantau aktivitas karyawan Jonusa hari ini.", style: TextStyle(color: Colors.white70, fontSize: 14)),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  _buildStatCard("Izin/Sakit", "3", Icons.assignment_late, Colors.orange),
                ],
              ),
            ),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: const Text("Menu Utama", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),
